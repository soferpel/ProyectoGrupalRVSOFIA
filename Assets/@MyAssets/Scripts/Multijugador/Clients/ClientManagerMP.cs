...
public class ClientManagerMP : NetworkBehaviour
{
    ...
    private void Update()
    {
        ...
        if (mafia == null)
        {
            ...
            mafia.GetComponent<MafiaControllerMP>().GenerateOrder();
    ...
    private GameObject SpawnClient(GameObject prefab)
    {
        ...
        PersonControllerMP controller = client.GetComponent<PersonControllerMP>();
        ...
        if (client.TryGetComponent(out MafiaControllerMP mafiacontr))
        {
